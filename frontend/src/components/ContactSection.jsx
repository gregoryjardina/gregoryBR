    ...
    <section id="contato" data-testid="contact-section" ref={ref} className="py-20 sm:py-24 px-5 sm:px-8">
      <div className="max-w-xl mx-auto text-center">
        ...
        <motion.div variants={fade} initial="hidden" animate={inView ? "show" : "hidden"} transition={{ duration: 0.5, delay: 0.16 }}
          ...
          <a data-testid="contact-linkedin-button" href="https://linkedin.com/in/gregoinfortech" target="_blank" rel="noopener noreferrer"
          ...
          <a data-testid="contact-instagram-button" href="https://instagram.com/gregoinfortech" target="_blank" rel="noopener noreferrer"
