const translations = {
  en: {
    ...
    about: {
      ...
      title: "Gregory Porto",
      paragraphs: [
        "I currently work in the IT department at Alimentos Toscana, supporting the evolution of technological infrastructure, corporate support, internal process organization and operational stability, including TOTVS, networks, Microsoft 365 and corporate solutions.",
        "With over 10 years of experience in IT, I have worked with technical support, infrastructure, networks, information security and enterprise systems. Former Brazilian Navy Marine with operations in the Amazon, I also had diverse experiences that developed discipline, resilience and adaptability.",
  ...
  pt: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        "Com mais de 10 anos de experiência em TI, atuei com suporte técnico, infraestrutura, redes, segurança da informação e sistemas empresariais. Ex-Fuzileiro Naval com operações na Amazônia, também vivi experiências em áreas diversas que desenvolveram disciplina, resiliência e capacidade de adaptação.",
